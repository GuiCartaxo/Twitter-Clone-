	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready( function(){
					...
					$.ajax({
						...
						success: function(data) {
							...
							$('.btn_excluir').click( function(){
								...
								var tweet_excluido = this.id;

								deletaTweets(tweet_excluido);
				...
				function deletaTweets(tweet_excluido){
					$.ajax({
						url: 'exclui_tweet.php',
						method: 'post',
						data: {'dados':tweet_excluido},
						success: function(data) {
							atualizaTweet();
							atualizaQtdeTweet();
							atualizaQtdeSeguidores();
	    	...
	    	<div class="col-md-3">
	    		<div class="panel panel-default">
	    			<div class="panel-body">
	    				...
	    				<hr />
	    				<div class="col-md-6">
	    					TWEETS <br /> <span id="qtde_tweets"><?= $qtde_tweets ?></span>
	    				</div>
	    				<div class="col-md-6">
	    					SEGUIDORES <br /> <span id="qtde_seguidores"><?= $qtde_seguidores ?></span>
	    				</div>
	    			</div>
	    		</div>
	    	</div>
